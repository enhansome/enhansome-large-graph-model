...
* \[arXiv 2023.05] StructGPT: A General Framework for Large Language Model to Reason over Structured Data [\[paper\]](https://arxiv.org/pdf/2305.09645)  [\[code\]](https://github.com/RUCAIBox/StructGPT) ⭐ 417 | 🐛 0 | 🌐 Python | 📅 2023-11-28
* \[arXiv 2023.04] Graph-ToolFormer: To Empower LLMs with Graph Reasoning Ability via Prompt Augmented by ChatGPT [\[paper\]](https://arxiv.org/pdf/2304.11116)  [\[code\]](https://github.com/jwzhanggy/Graph_Toolformer) ⭐ 251 | 🐛 1 | 🌐 Python | 📅 2023-09-04
